...
LiquidCrystal_I2C lcd(0x27,20,4); //I2C Address: 0x27, 20x4 LCD(20 columns x 4
rows)
...
boolean butter1 = true, cheese1 = true, doritos1 = true, watermelon1 = true, milano1
= true;
...
if(c%2 == 1)
{
Serial.println("200g Cheese Added toCart");
